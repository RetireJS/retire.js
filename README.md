...
-------------------------
@h3xstream has adapted Retire.js as a plugin for both of the penetration testing tools [Burp](http://portswigger.net/burp/) and [OWASP ZAP](https://www.owasp.org/index.php/OWASP_Zed_Attack_Proxy_Project).
